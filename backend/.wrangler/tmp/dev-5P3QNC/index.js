...
// .wrangler/tmp/bundle-zgmMBS/checked-fetch.js
...
var require_edge = __commonJS({
  "../../../../node_modules/@prisma/client/runtime/edge.js"(exports, module) {
    ...
    var $c = {};
    ar($c, { Debug: () => ln, Decimal: () => he, Extensions: () => nn, MetricsClient: () => Xe, NotFoundError: () => xe, PrismaClientInitializationError: () => J, PrismaClientKnownRequestError: () => W, PrismaClientRustPanicError: () => Pe, PrismaClientUnknownRequestError: () => ne, PrismaClientValidationError: () => z2, Public: () => on, Sql: () => ie, defineDmmfProperty: () => Hi, empty: () => Yi, getPrismaClient: () => zs, getRuntime: () => _r, join: () => zi, makeStrictEnum: () => Ys, objectEnumValues: () => gr, raw: () => wn, sqltag: () => En, warnEnvConflicts: () => void 0, warnOnce: () => Ct });
    module.exports = ia($c);
    f();
    c();
    p();
    ...
    N(z2, "PrismaClientValidationError");
    f();
    c();
    p();
    m();
    ...
    function du(e, t, r) {
      return async (n) => {
        if ("rejectOnNotFound" in n.args) {
          ...
          throw new z2(o, { clientVersion: t });
        }
...
${r}`, L(n, true));
    ...
    function ss({ copyEngine: e = true }, t) {
      ...
      if (i && o || o) {
        let l;
        throw l = ["Prisma Client was configured to use the `adapter` option but it was imported via its `/edge` endpoint.", "Please either remove the `/edge` endpoint or remove the `adapter` from the Prisma Client constructor."], new z2(l.join(`
`), { clientVersion: t.clientVersion });
      }
      if (i)
        return new Yt(t);
      throw new z2("Invalid client engine type, please use `library` or `binary`", { clientVersion: t.clientVersion });
    }
    f();
    c();
    p();
...
Note that ${s.bold("include")} statements only accept relation fields.`, a;
    ...
    function qr({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
      ...
      throw new z2(g, { clientVersion: o });
    }
      ...
      class t {
        ...
        $runCommandRaw(n) {
          if (e.activeProvider !== "mongodb")
            throw new z2(`The ${e.activeProvider} provider does not support $runCommandRaw. Use the mongodb provider.`, { clientVersion: this._clientVersion });
  ...
  "../../../../node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/Users/syedubaid/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
      ...
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../Desktop/vs/InkWave/backend/.env"
      },
      "relativePath": "../../../Desktop/vs/InkWave/backend/prisma",
...
// .wrangler/tmp/bundle-zgmMBS/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-zgmMBS/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
